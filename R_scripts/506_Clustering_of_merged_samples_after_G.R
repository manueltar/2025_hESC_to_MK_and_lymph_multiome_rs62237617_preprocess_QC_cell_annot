...
merge_and_recall_peaks = function(option_list)
{
  ...
  adata2<-readRDS(file=opt$db_filt_clustered_QCed_cell_annotated_MJ_only_genotyped)
  ...
  saveRDS(adata2, file = 'merged_unprocessed_db_filt_clustered_QCed_cell_annotated_MJ_only_genotyped_reclustered.rds')
...
main = function() {
  ...
  cat(paste(gsub("--file=", "", cmd_line[4], fixed=T),
            ...
            "\n\n"))
  option_list <- list(
    make_option(c("--db_filt_clustered_QCed_cell_annotated_MJ_only_genotyped"), type="character", default=NULL, 
                metavar="type", 
