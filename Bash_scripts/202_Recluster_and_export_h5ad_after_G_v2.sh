...
Pythonscript_convert_to_h5ad=$(echo "$Pythonscripts_path""4_export_to_h5ad_ATAC_and_RNA_for_SIMBA_v3.py")
...
# --dependency=afterany:$myjobid_MACS2_calling_by_annotation
